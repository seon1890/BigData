'''
$ spark-submit test_small.py bt2227 20 0.1
'''
...
if __name__ == "__main__":
    memory = "8g"
    spark = SparkSession.builder.appName("Test Small").master('yarn').config("spark.executor.memory", memory).config("spark.driver.memory", memory).getOrCreate()
    path = sys.argv[1]
    rank = int(sys.argv[2])
